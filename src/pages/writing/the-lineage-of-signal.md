...
His worlds feel constructed because they are. Every element reinforces the same pressure. The individual does not shape the system. The system shapes the individual.

There is no speech explaining this. No narrator to guide interpretation.
...
Artificial intelligence. Financial infrastructure. Civic systems that decide outcomes at scale.
...
Kubrick ensured it could be felt.
