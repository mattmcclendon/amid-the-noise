...
a subscription activates correctly,
a network outage resolves itself,
...
<figure class="artifact-figure artifact-figure--wide">
  <img src="/images/writing/aol-quickview-dashboard.png" alt="Early AOL QuickView dashboard showing modular widgets for weather, trends, maps, and personalized information surfaces." />
...
<figure class="artifact-figure artifact-figure--portrait">
  <img src="/images/writing/evernote-hello-encounter-memory.png" alt="Evernote Hello mobile encounter screen showing a person, location, notes, audio, and photos." />
  <figcaption>Evernote Hello treated human encounters as contextual memory: person, place, time, notes, and media held together in one interface.</figcaption>
</figure>
...
Not artificial intelligence in the modern sense. Something quieter:
a system designed to preserve human orientation across increasingly fragmented social environments.
...
The problem space could not have looked more different. Instead of human relationships, the system visualized small-business network infrastructure:
routers,
switches,
...
<figure class="artifact-figure artifact-figure--wide">
  <img src="/images/writing/cisco-onplus-network-topology.png" alt="Cisco OnPlus network topology visualization showing clients, health status, and connected systems." />
  <figcaption>Network infrastructure translated into spatial reasoning: clients, dependencies, health, and operational state made visible.</figcaption>
</figure>
...
<figure class="artifact-figure artifact-figure--wide">
  <img src="/images/writing/cisco-onplus-dsl-recommendation.png" alt="Cisco OnPlus DSL recommendation modal showing connection capacity, performance metrics, and upgrade guidance." />
  <figcaption>Telemetry becoming judgment: degraded service surfaced with context, recommendation, and next action.</figcaption>
</figure>
...
<figure class="artifact-figure artifact-figure--wide">
  <img src="/images/writing/autodesk-cloud-services-dashboard.png" alt="Autodesk cloud services dashboard showing products, services, storage, subscriptions, and access controls." />
  <figcaption>Desktop software becoming a service ecosystem, with identity, entitlement, storage, and access folded into one account surface.</figcaption>
</figure>
...
<figure class="artifact-figure artifact-figure--wide artifact-figure--dark">
  <img src="/images/writing/cadence-virtuoso-schematic-editor.png" alt="Cadence Virtuoso schematic editor showing a dense semiconductor schematic and simulation plots." />
  <figcaption>Expert-system interface design at the edge of human comprehension, where abstraction preserves access to extreme technical complexity.</figcaption>
</figure>
...
Poor simplification hides reality.
Good simplification preserves reality while making navigation possible.
...
.artifact-figure--wide {
  max-width: 980px;
}

.artifact-figure--portrait {
  max-width: 520px;
}
